...
export default class LocalStorage {
  ...
  /**
   * Check if localStorage has an Item / exists with the given key
  ...
  /**
   * This function returns the maximum size of localStorage without affecting
   * it's content Might be slow !!!
   */
